    ...
    return (
        <>
            <section className='bg-hf_extra h-[100vh]' >
                ...
                <div className=' py-[20px] px-[16px] md:p-[30px] bg-white  max-w-[343px] md:mt-[263px] mt-[163px] md:max-w-[510px] w-full m-auto  text-center' >
                    <h2 className=' pb-[30px] text_24_20 text-blue_gray_700' > Enter New Password</h2>
                    <Input
