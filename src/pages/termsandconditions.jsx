    ...
    <>
      <section className=" mt-[159px] ">
        <div className=" py-[30px] bg-extra_bg">
          <Policytittle className="mt-[60px]">Terms & Condition</Policytittle>
        </div>
        <div className="py-5 md:py-10 container">
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            <h4 className="text_24_20 text-blue_gray_700">Introduction</h4>
            <p className="text_16_1_14 text-blue_gray_500 mt-[14px] md:mt-5 text-justify">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu
              turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus
              nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum
              tellus Maecenas eget condimentum velit, sit amet feugiat lectus.
              Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per inceptos himenaeos. Ac scelerisque ante pulvinar.
              Donec ut rhoncus ex. Suspendisse ac rhoncus nisl, eu tempor
              urna.Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per inceptos himenaeos. Ac scelerisque ante pulvinar.
              Donec ut rhoncus ex. Suspendisse ac rhoncus nisl Curabitur vel
              ...
              inceptos himenaeos. Ac scelerisque ante pulvinar. Donec ut rhoncus
              ex. Suspendisse ac rhoncus nisl
            </p>
            <p className="text_16_1_14 text-blue_gray_500 mt-[10px] md:mt-[15px] text-justify">
              Suspendisse ac rhoncus nisl, eu tempor urna Lorem ipsum dolor sit
          ...
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            <h4 className="text_24_20 text-blue_gray_700">
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[14px] md:mt-5 text-justify">
              ...
              aptent taciti sociosqu ad litora torquent per conubia nostra, per
              inceptos himenaeos. Ac scelerisque ante pulvinar. Donec ut rhoncus
              ex. Suspendisse ac rhoncus nisl, eu tempor urnaLorem ipsum dolor
              ...
              ex. Suspendisse ac rhoncus nisl, eu tempor urna. Curabitur vel
              bibendum lorem. Morbi convallis convallis diam sit amet lacinia.
              Aliquam in elementum tellus. Lorem ipsum dolor sit amet, sit amet
              feugiat lectus. Class aptent taciti sociosqu ad litora torquent
              per conubia nostra, per inceptos himenaeos. Ac scelerisque ante
              pulvinar.
            </p>
            <p className="text_16_1_14 text-blue_gray_500 mt-[10px] md:mt-[15px] text-justify">
              Donec ut rhoncus ex. Suspendisse ac rhoncus nisl, eu tempor urna.
              ...
              conubia nostra, per inceptos himenaeos. Ac scelerisque ante
              pulvinar. Donec ut rhoncus ex. Suspendisse ac rhoncus nislLorem
          ...
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[14px] md:mt-5 text-justify">
              Morbi convallis convallis diam sit amet laciniaLorem ipsum dolor
              sit amet, consectetur adipiscing elit. Etiam eu turpis molestie,
              dictum est a, mattis tellus. Sed dignissim, metus nec fringilla
              accumsan, risus sem sollicitudin lacus, ut interdum tellus
              Maecenas eget condimentum velit, sit amet feugiat lectus. Class
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[10px] md:mt-[15px] text-justify">
              Etiam eu turpis molestieSuspendisse ac rhoncus nisl, eu tempor
              urna. Curabitur vel bibendum lorem. Morbi convallis convallis diam
              sit amet lacinia. Aliquam in elementum tellus. Lorem ipsum dolor
              sit amet, consectetur adipiscing elit. Etiam eu turpis molestie,
              dictum est a, mattis tellus. Sed dignissim, metus nec fringilla
              accumsan, risus sem sollicitudin lacus, ut interdum tellus elit
              sed risus. Maecenas eget condimentum velit, sit amet feugiat
          ...
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[10px] md:mt-[15px] text-justify">
              Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per inceptos himenaeos.Donec ut rhoncus ex. Suspendisse ac
              ...
              himenaeos. Ac scelerisque ante pulvinar. Donec ut rhoncus ex.
              Suspendisse ac rhoncus nislLorem ipsum dolor sit amet, consectetur
              adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis
              tellus. Sed dignissim, metus nec fringilla accumsan, risus sem
              sollicitudin lacus, ut interdum tellus Maecenas eget condimentum
              velit, sit amet feugiat lectus. Class aptent taciti sociosqu ad
              litora torquent per conubia nostra, per inceptos himenaeos. Ac
          ...
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            <h4 className="text_24_20 text-blue_gray_700">
              Cancellation Policy in Fashion Cart
            </h4>
            <p className="text_16_1_14 text-blue_gray_500 mt-[14px] md:mt-5 text-justify">
              Maecenas eget condimentum velit, sit amet feugiat lectus. Class
              aptent taciti sociosqu ad litora torquent per conubia nostra, per
              inceptos himenaeos. Ac scelerisque ante pulvinar. Donec ut rhoncus
              ex. Suspendisse ac rhoncus nislLorem ipsum dolor sit amet,
              consectetur adipiscing elit. Etiam eu turpis molestie, dictum est
              a, mattis tellus. Sed dignissim, metus nec fringilla accumsan,
              risus sem sollicitudin lacus, ut interdum tellus Maecenas eget
              condimentum velit, sit amet feugiat lectus. Class aptent taciti
              sociosqu ad litora torquent per conubia nostra, per inceptos
              himenaeos. Ac scelerisque ante pulvinar. Donec ut rhoncus ex.
            ...
            {/* <p className='text_16_1_14 text-blue_gray_500 mt-[15px]'>
          ...
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[14px] md:mt-5 text-justify">
              Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per inceptos himenaeos , eu tempor urna. Curabitur vel
              bibendum lorem. Morbi convallis convallis diam sit amet lacinia.
              Aliquam in elementum tellus. Lorem ipsum dolor sit amet,
              consectetur adipiscing elit. Etiam eu turpis molestie, dictum est
              a, mattis tellus. Sed dignissim, metus nec fringilla accumsan,
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[10px] md:mt-[15px] text-justify">
              ...
              Aliquam in elementum tellus. Lorem ipsum dolor sit amet,
              consectetur adipiscing elit. Etiam eu turpis molestie, dictum est
              a, mattis tellus. Sed dignissimClass aptent taciti sociosqu ad
              litora torquent per conubia nostra, per inceptos himenaeos. Ac
              scelerisque ante pulvinar. Donec ut rhoncus ex. Suspendisse ac
              rhoncus nislLorem ipsum dolor sit amet, consectetur adipiscing
              eli,
            </p>
          </div>
          ...
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            ...
            <p className="text_16_1_14 text-blue_gray_500mt-[14px] md:mt-5 text-justify">
              Aliquam in elementum tellus. Donec ut rhoncus ex. Suspendisse ac
              rhoncus nisl, eu tempor urna. Curabitur vel bibendum lorem. Morbi
              convallis convallis diam sit amet lacinia. Aliquam in elementum
              tellus. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              Etiam eu turpis molestie, dictum est a, mattis tellus. Sed
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[10px] md:mt-[15px] text-justify">
              Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per inceptos himenaeos. Ac scelerisque ante pulvinar.
              Donec ut rhoncus ex. Suspendisse ac rhoncus nislLorem ipsum dolor
              sit amet, consectetur adipiscing elit. Etiam eu turpis molestie,
              dictum est a, mattis tellus. Sed dignissim, metus nec fringilla
              accumsan, risus sem sollicitudin lacus, ut interdum tellus
              Maecenas eget condimentum velit, sit amet feugiat lectus. Class
          ...
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[14px] md:mt-5 text-justify">
              Etiam eu turpis molestie, dictum est a, mattis tellus.Donec ut
            ...
            <p className="text_16_1_14 text-blue_gray_500 mt-[10px] md:mt-[15px] text-justify">
              Donec ut rhoncus ex. Suspendisse ac rhoncus nisl, eu tempor
              urnaMaecenas eget condimentum velit, sit amet feugiat lectus.
              Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per inceptos himenaeos. Ac scelerisque ante pulvinar.
              Donec ut rhoncus ex. Suspendisse ac rhoncus nislLorem ipsum dolor
              sit amet, consectetur adipiscing elit. Etiam eu turpis molestie,
          ...
          <div className="border-b-[1px] pb-[30px] mb-[30px]">
            <h4 className="text_24_20 text-blue_gray_700">Profanity Policy</h4>
            <p className="text_16_1_14 text-blue_gray_500 mt-[14px] md:mt-5 text-justify">
              Etiam eu turpis molestie, dictum est a, mattis tellus.Donec ut
              rhoncus ex. Suspendisse ac rhoncus nisl, eu tempor urna. Curabitur
              vel bibendum lorem. Morbi convallis convallis diam sit amet
